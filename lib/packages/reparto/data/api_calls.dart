...
class Servidor {
  ...
  /**
   * Llamadas referentes a Repartidores
   */

  Future<HojaRuta> getHojaByRepartidor(String idRepartidor) async{
    String endpoing = "/Hoja";
    String params = "&idRepartidor="+idRepartidor;

    List<Paquete> paquetes = [];
    return new HojaRuta("id", paquetes, "nombre", "fecha");
  }
